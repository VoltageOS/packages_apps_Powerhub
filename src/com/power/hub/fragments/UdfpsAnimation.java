...
public class UdfpsAnimation extends InstrumentedFragment {

    private RecyclerView mRecyclerView;
    private String mPkg = "com.power.hub.udfps.animations";
    ...
    private void loadResources() {
        ...
        int animStylesId = udfpsRes.getIdentifier("udfps_animation_styles", "array", mPkg);
        int animPreviewsId = udfpsRes.getIdentifier("udfps_animation_previews", "array", mPkg);
        int animTitlesId = udfpsRes.getIdentifier("udfps_animation_titles", "array", mPkg);

        if (animStylesId != 0 && animPreviewsId != 0 && animTitlesId != 0) {
            mAnims = udfpsRes.getStringArray(animStylesId);
            mAnimPreviews = udfpsRes.getStringArray(animPreviewsId);
            mTitles = udfpsRes.getStringArray(animTitlesId);
        }
    }
