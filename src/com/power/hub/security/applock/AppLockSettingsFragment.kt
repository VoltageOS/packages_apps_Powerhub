...
package com.power.hub.security.applock
...
class AppLockSettingsFragment : PowerhubDashboardFragment(),
    ...
    override protected fun getPreferenceScreenResId() = R.xml.powerhub_app_lock
    ...
    companion object {
        ...
        @JvmField
        val SEARCH_INDEX_DATA_PROVIDER = BaseSearchIndexProvider(R.xml.powerhub_app_lock)
    }
}
